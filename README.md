...
`재평가 계기`, `거버넌스`, `확신도` 같은 정성 항목은 자동 수집만으로 채우기 어렵습니다. 그래서 이 프로젝트는 [manual-overrides.csv](/Users/ahn-yongsung/Project/investment-checklist-screener/data/manual-overrides.csv) 를 함께 읽도록 되어 있습니다.
...
```csv
stockCode,name,catalyst,governance,confidence,netCash,market,sector,note
005930,삼성전자,strong,medium,high,,,,반도체 업황 회복과 주주환원 정책을 계속 추적
035420,NAVER,medium,,medium,,,,광고/커머스 수익성 회복 여부 계속 체크
```

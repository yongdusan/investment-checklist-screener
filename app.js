...
function createStockCard(stock) {
  ...
  metrics.append(
    ...
    createMetric("EV/EBITDA", stock.evToEbitda || "-"),
    createMetric("FCF Yield", stock.fcfYield ? `${stock.fcfYield}%` : "-"),
    ...
    createMetric("ROIC 3년추세", stock.roicTrend3Y ? `${stock.roicTrend3Y}%p` : "-"),
    createMetric("마진 3년추세", stock.opMarginTrend3Y ? `${stock.opMarginTrend3Y}%p` : "-"),
